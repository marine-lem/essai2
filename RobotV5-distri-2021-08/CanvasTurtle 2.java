...
public class CanvasTurtle
{
     ...
     */
    public static void northTurtle(int x, int y)
    {
        int xp = x*50 + midth + 5;
        int yp = y*50 + midth;
     ...
     * @param  x,y  turtle position
     */
    public static void southTurtle(int x, int y)
    {
        int xp = x*50 + midth + 5;
        int yp = y*50 + midth;
        Canvas canvas = Canvas.getCanvas(); 
     ...
     * @param  x,y  turtle position
     */
    public static void eastTurtle(int x, int y)
    {
        int xp = x*50 + midth;
        int yp = y*50 + midth + 5;
        Canvas canvas = Canvas.getCanvas(); 
     ...
     * @param  x,y  turtle position
     */
    public static void westTurtle(int x, int y)
    {
        int xp = x*50 + midth;
        int yp = y*50 + midth + 5;
        Canvas canvas = Canvas.getCanvas(); 
     ...
     */
    public static void drawVertical(int x1, int y1, String color)
    {
     ...
     * @param  x1,y1   starting position (grid coordinates)
     */
    public static void drawHorizontal(int x1, int y1, String color)
    {
        String line = new String("Line" + n++);
        Canvas canvas = Canvas.getCanvas(); 
        int xPosition = x1*50 + midth + 23;
    ...
    {
        CanvasTurtle.northTurtle(1,-2);
        CanvasTurtle.drawVertical (1,-2, "black");
    }
}
